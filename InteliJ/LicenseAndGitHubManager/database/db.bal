...
function repositorySelectFromId(int id)(message){
    ...
    try{
        system:println(id);
        string query = "SELECT LM_REPOSITORY.*,LM_LICENSE.LICENSE_NAME,LM_LICENSE.LICENSE_KEY,LM_ORGANIZATION.ORGANIZATION_NAME,LM_REPOSITORYTYPE.REPOSITORYTYPE_NAME from LM_REPOSITORY
