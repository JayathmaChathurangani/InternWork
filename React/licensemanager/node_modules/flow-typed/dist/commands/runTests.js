...
function runTestGroup(testGroup) {
  ...
  return regeneratorRuntime.async(function runTestGroup$(_context10) {
    while (1) {
      switch (_context10.prev = _context10.next) {
        case 0:
          // Some older versions of Flow choke on ">"/"<"/"="
          testDirName = testGroup.id.replace("/", "--").replace(/>/g, "gt").replace(/</g, "lt").replace(/=/g, "eq");
        ...
        case 10:
          orderedFlowVersions = _context10.sent;
          _context10.next = 18;
          break;
        ...
        case 18:
          ...
          return regeneratorRuntime.awrap(function _callee6() {
            var destLibDefPath, destFlowConfigPath, flowConfigData, testGrpFlowSemVerRange, flowVersionsToRun, lowestFlowVersionRan, testBatch, lowerFlowVersionsToRun, lowestCapableFlowVersion, lowerTestBatch;
              ...
              while (1) {
                switch (_context9.prev = _context9.next) {
                  ...
                  case 21:
                    ...
                    _context9.next = 25;
                    return regeneratorRuntime.awrap(P.all(lowerTestBatch.map(function _callee5(flowVer) {
                      var _ref5, errCode, execError;
                          ...
                          switch (_context8.prev = _context8.next) {
                            case 0:
                              ...
                              return regeneratorRuntime.awrap(new Promise(function (res) {
                                ...
                                child.on("error", function (execError) {
                                  res({ errCode: null, execError: execError });
                                });

                                child.on("close", function (errCode) {
                                  res({ errCode: errCode, execError: null });
                                });
                              }));
...
function runTests(repoDirPath, testPatterns, onlyChanged) {
  ...
  return regeneratorRuntime.async(function runTests$(_context11) {
    while (1) {
      switch (_context11.prev = _context11.next) {
        ...
        case 3:
          _context11.t0 = function (testGroup) {
          ...
          testGroups = _context11.sent.filter(_context11.t0);
          _context11.prev = 5;
          _context11.next = 8;
        ...
        case 18:
          testGroupErrors = _context11.sent;
    ...
    while (1) {
      switch (_context12.prev = _context12.next) {
        ...
        case 9:
          ...
          _context12.t0 = cwdDefsNPMPath;
          _context12.next = 14;
          break;

        case 13:
          _context12.t0 = _node.path.join(__dirname, "..", "..", "..", "definitions", "npm");

        case 14:
          repoDirPath = _context12.t0;
